...
var Sound = new Class({ 
   ...
   //     console.log(this.swf.getBytesLoaded(this.url));
	...
	getPosition: function() {
     //   console.log(this.swf.getPosition(this.url));
	...
	checkPosition: function() {
		...
		if ($type(position) === "number" && position !== this.listeners.lastPosition) { 
			...
			this.fireEvent('onPosition', [(position / 1000).round(1), (this.duration / 1000).round(1)]);
		}
	},
